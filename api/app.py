"""
Vercel Entrypoint for the AI Personal Assistant Flask App.
This file contains the entire Flask application logic, moved here to ensure
Vercel can detect the entrypoint without import issues.
"""
import os
import sys
import json
...
# ----------------------------------------------------------------------------
# VERCEL-SPECIFIC PATH CORRECTION
# ----------------------------------------------------------------------------
# Get the absolute path of the current file (api/app.py)
# Vercel runs this file from the root of the project.
# We need to add the 'ai_assistant/backend' directory to the system path
...
# |- ai_assistant/
# |  |- backend/
# |  |  |- free_api_processor.py
# |  |  |- ... other modules
#
# The working directory in Vercel is /var/task/, so we construct the path from there.
...
# --- The rest of your application code from ai_assistant/backend/app.py ---
